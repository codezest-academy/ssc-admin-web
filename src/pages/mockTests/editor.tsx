...
import { getMockTestById, createMockTest, updateMockTest } from "@/api/mockTests";
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="space-y-8 bg-card p-6 rounded-xl border">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">The builder will validate sections against these targets.</p>
        ...
        <div className="space-y-4">
          <h3 className="font-semibold border-b pb-2">Marking Scheme (Default)</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <Label className="text-success">Marks per Correct Answer (+)</Label>
              <Input 
                type="number" 
                step="0.1"
            ...
            <div className="space-y-2">
              <Label className="text-destructive">Marks per Incorrect Answer (-)</Label>
              <Input 
                type="number" 
                step="0.1"
              ...
              />
              <p className="text-xs text-muted-foreground">Enter as a positive number (e.g. 0.5)</p>
            </div>
            <div className="space-y-2">
